...
interface AfipSplitPaymentDialogProps {
  open: boolean;
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <Input
                  ...
                  value={afipPaymentProcessor.cashAmount}
                  onChange={(e) =>
                    afipPaymentProcessor.setCashAmount(e.target.value)
                  }
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button
                  variant={
                    afipPaymentProcessor.secondPaymentMethod === "tarjeta"
                      ? "default"
                      : "outline"
                  }
                  className={
                  ...
                  onClick={() =>
                    afipPaymentProcessor.setSecondPaymentMethod("tarjeta")
                  }
                  disabled={afipPaymentProcessor.isProcessingPayment}
                >
                ...
                <Button
                  variant={
                    afipPaymentProcessor.secondPaymentMethod === "qr"
                      ? "default"
                      : "outline"
                  }
                  className={
                  ...
                  onClick={() =>
                    afipPaymentProcessor.setSecondPaymentMethod("qr")
                  }
                  disabled={afipPaymentProcessor.isProcessingPayment}
                >
